...
class DesaDataTable extends DataTable
{
        ...
        ->addColumn('#', function($item) {
            ...
            $actionButton = "<div class='dropdown'>
                                ...
                                <div class='dropdown-menu dropdown-menu-end'>
                                    <a class='dropdown-item' href='#' data-bs-toggle='modal' data-bs-target='#editModal' data-url='{$editRoute}' data-type='{$item->type}' data-name='{$item->name}' data-code='{$item->code}' data-kecamatan_id='{$item->kecamatan_id}'>
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('kecamatan.kabupaten.name')->title('Kabupaten'),
