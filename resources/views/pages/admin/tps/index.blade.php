                            ...
                            <select name="desa_id" class="form-select" required>
                                ...
                                @foreach ($desa as $item)
                                    <option value="{{ $item->id }}">{{ $item->name }} -
                                        {{ $item->kecamatan->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Location</label>
                            <textarea class="form-control" name="location" rows="3" placeholder="Detail Location" required></textarea>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                <form id="editForm" action="#" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Desa/Kelurahan</label>
                            <select name="desa_id" id="desa_id_edit" class="form-select" required>
                                <option value="" selected disabled>- select options -</option>
                                @foreach ($desa as $item)
                                    <option value="{{ $item->id }}">{{ $item->name }} -
                                        {{ $item->kecamatan->name }}</option>
                        ...
                        <div class="mb-3">
                            <label class="form-label">Location</label>
                            <textarea class="form-control" name="location" id="location_edit" rows="3" placeholder="Detail Location"
                                required></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
